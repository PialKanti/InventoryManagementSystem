...
import static com.codecrafters.hub.inventorymanagementsystem.constant.RabbitQueueName.PRODUCT_CREATE_QUEUE;
...
public class ProductCreateListener {
    ...
    public void receive(ProductDocument product) {
        log.info("Received product for creating document in elastic search: {}", product);
